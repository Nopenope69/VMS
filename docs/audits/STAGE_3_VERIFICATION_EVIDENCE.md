...
| **Continuous Multi-Stream Scale Ingestion** | Ingest, segment, and index back-to-back segments across 64 concurrent streams. 0 unrecoverable gaps; 100% segment integrity and hash computation in automated test harness. | **PASS** (Automated Scale Harness)<br>**FIELD PENDING** (0/168h Physical Soak) | [`backend/src/__tests__/soakWorkload64.test.ts`](../../backend/src/__tests__/soakWorkload64.test.ts) |
...
| **Playwright Frontend Smoke & Operations** | End-to-end coverage across all 6 core operator workflows: Authentication, Live Grid, Playback timeline scrubber, Section 63 Evidence, Storage Management, and Alarms. | **PASS** | [`frontend/e2e/operations.spec.ts`](../../frontend/e2e/operations.spec.ts)<br>[`backend/src/__tests__/frontendOperationsSmoke.test.ts`](../../backend/src/__tests__/frontendOperationsSmoke.test.ts) |
